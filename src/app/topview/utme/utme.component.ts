...
import { StatusMessage } from 'src/app/shared/interfaces/students';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'app-utme',
  templateUrl: './utme.component.html',
  styleUrls: ['./utme.component.css']
})
...
ngOnDestroy() {
  ...
  onFormSubmit() {
    ...
    const upload$ = this.http.post(`${this.apiUrl}/api/uploadutme`, formData, {
      reportProgress: true,
      observe: 'events'
      })
      .pipe(
